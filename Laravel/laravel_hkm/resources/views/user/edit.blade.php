                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="role_id" id="role_id">
                                        ...
                                        <option value="4" {{ ($data->role_id == 4) ? 'selected' : '' }} >Khác</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ $data->name }}" type="text" class="form-control" id="name" name="name" placeholder="Nhập Họ và Tên">
                                    @if($errors->has('name'))
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input {{ ($data->is_active == 1) ? 'checked' : '' }} name="is_active" id="is_active" type="checkbox" value="1"> Kích hoạt tài khoản
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset($data->avatar) }}" style="width: 350px; height: 250px; margin-top: 10px">
                                </div>
                            </div>
                        </div>
